...
class BankUi:
    def __init__(self,root):
        self.root = root
        self.header = Label(self.root,text="GoCash Bank",bg="#00688B",fg="white",font=("times new roman",20,"bold"))
        self.header.pack(fill=X)
        self.frame = Frame(self.root,bg="#00688B",width=900,height=500)
        root.geometry("800x500")
        self.label1 = Label(self.frame, text="Welcome To GoCash Bank", bg="#00688B", fg="white", font=("times new roman",30,"bold"))
        self.button1 = Button(self.frame,text="Click to begin transactions",bg="#0A1172",fg="white",font=ARIAL, command = self.begin_page)
        self.q = Button(self.frame, text="Quit", bg="#0A1172", fg="white", font=ARIAL, command=self.root.destroy)
        self.q.place(x=340, y=340, width=200, height=60)
        self.button1.place(x=175,y=230,width=500,height=70)
        self.label1.place(x=30, y=100, width=800, height=30)
        self.countter = 2
        self.frame.pack()
    ...
    def begin_page(self):
        ...
        self.frame = Frame(self.root,bg="#00688B",width=900,height=500)
        root.geometry("800x500")
        self.label1 = Label(self.frame, text="Please Select Your Choice", bg="#00688B", fg="white",
                            font=("times new roman", 30, "bold"))
        self.enroll = Button(self.frame, text="Enroll",bg="#0A1172",fg="white",font=ARIAL,command=self.enroll_user)
        self.withdraw = Button(self.frame, text="Withdraw Money",bg="#0A1172",fg="white",font=ARIAL,command=self.withdraw_money_page)
        self.q = Button(self.frame, text="Quit", bg="#0A1172", fg="white", font=ARIAL, command=self.root.destroy)
        self.enroll.place(x=5, y=315, width=200, height=50)
        self.withdraw.place(x=600, y=315, width=200, height=50)
        self.q.place(x=340, y=340, width=120, height=40)
        self.label1.place(x=45, y=100, width=800, height=30)
        self.frame.pack()
    ...
    def withdraw_money_page(self):
        ...
        self.label2 =Label(self.frame,text="1.By clicking on the 'Verify Face Id' button, we proceed to perform facial recognition.",bg="#00688B",fg="white",font=ARIAL)
        self.label3 =Label(self.frame,text="2.Each capture will take 15 seconds and you are required to move your face in different directions while being captured.",bg="#00688B",fg="white",font=ARIAL)
        self.label4 =Label(self.frame,text="3.If your face is recognized, you will be required to input your account password.",bg="#00688B",fg="white",font=ARIAL)
        self.label5 =Label(self.frame,text="4.If your face is not reconized after 5 seconds, you will automatically be given 2 trial more.",bg="#00688B",fg="white",font=ARIAL)
        self.label6 =Label(self.frame,text="5.If your face is not recognized after three trials, you wont be allowed to withdraw",bg="#00688B",fg="white",font=ARIAL)
        self.label7 =Label(self.frame,text="6.To Begin, Click The 'Verify Face Id' Button Below",bg="#00688B",fg="white",font=ARIAL)
        self.button = Button(self.frame,text="Verify Face Id",bg="#0A1172",fg="white",font=ARIAL,command=self.video_check)
        self.q = Button(self.frame,text="Quit",bg="#0A1172",fg="white",font=ARIAL,command = self.root.destroy)
        self.b = Button(self.frame,text="Back",bg="#0A1172",fg="white",font=ARIAL,command = self.begin_page)
    ...
    def enroll_user(self):
        ...
        self.frame = Frame(self.root,bg="#00688B",width=900,height=500)
        #Login Page Form Components
        self.userlabel =Label(self.frame,text="Full Name",bg="#00688B",fg="white",font=ARIAL)
        self.uentry = Entry(self.frame,bg="honeydew",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white")
        self.plabel = Label(self.frame, text="Password",bg="#00688B",fg="white",font=ARIAL)
        self.pentry = Entry(self.frame,bg="honeydew",show="*",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white")  
        self.button1 = Button(self.frame,text="Next",bg="#0A1172",fg="white",font=ARIAL,command = self.enroll_and_move_to_next_screen)
    ...
    def password_verification(self):
        ...
        #Login Page Form Components
        self.plabel = Label(self.frame, text="Please enter your account password",bg="#00688B",fg="white",font=ARIAL)
        self.givenpentry = Entry(self.frame,bg="honeydew",show="*",highlightcolor="#50A8B0",
           highlightthickness=1,
            highlightbackground="white")  
        self.button1 = Button(self.frame,text="Verify",bg="#0A1172",fg="white",font=ARIAL,command=self.verify_user)
        self.q = Button(self.frame,text="Quit",bg="#0A1172",fg="white",font=ARIAL,command = self.root.destroy)
        self.b = Button(self.frame,text="Back",bg="#0A1172",fg="white",font=ARIAL,command = self.begin_page)
    ...
    def final_page(self):
        self.frame.destroy()
        self.frame = Frame(self.root,bg="#00688B",width=900,height=500)
        self.detail = Button(self.frame,text="Transfer",bg="#0A1172",fg="white",font=ARIAL,command = self.user_account_transfer)
        self.enquiry = Button(self.frame, text="Balance Enquiry",bg="#0A1172",fg="white",font=ARIAL,command = self.user_balance)
        self.deposit = Button(self.frame, text="Deposit Money",bg="#0A1172",fg="white",font=ARIAL,command = self.user_deposit_money)
        self.withdrawl = Button(self.frame, text="Withdraw Money",bg="#0A1172",fg="white",font=ARIAL,command = self.user_withdrawl_money)
        self.q = Button(self.frame, text="Log out", bg="#0A1172", fg="white", font=ARIAL, command=self.begin_page)
        ...
        self.q.place(x=340, y=340, width=140, height=40)
        self.frame.pack()
    ...
    def user_account_transfer(self):
        ...
        self.q.place(x=340, y=340, width=140, height=40)
        self.frame.pack()
        self.label11 = Label(self.frame, text="Please enter the reciepient's account number",bg="#00688B",fg="white",font=ARIAL)
        self.label21 = Label(self.frame, text="Please enter the amount to be transferred",bg="#00688B",fg="white",font=ARIAL)
        self.button1 = Button(self.frame,text="Transfer",bg="#0A1172",fg="white",font=ARIAL,command=self.user_account_transfer_transc)
    ...
    def user_balance(self):
        ...
        self.enquiry = Button(self.frame, text="Balance Enquiry",bg="#0A1172",fg="white",font=ARIAL,command = self.user_balance)
        self.deposit = Button(self.frame, text="Deposit Money",bg="#0A1172",fg="white",font=ARIAL,command = self.user_deposit_money)
        self.withdrawl = Button(self.frame, text="Withdrawl Money",bg="#0A1172",fg="white",font=ARIAL,command = self.user_withdrawl_money)
        self.q = Button(self.frame, text="Log out", bg="#0A1172", fg="white", font=ARIAL, command=self.begin_page)
        self.detail.place(x=0,y=0,width=200,height=50)
        self.enquiry.place(x=0, y=315, width=200, height=50)
        self.deposit.place(x=600, y=0, width=200, height=50)
    ...
    def user_deposit_money(self):
        ...
        self.money_box = Entry(self.frame,bg="honeydew",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white")
        self.submitButton = Button(self.frame,text="Deposit",bg="#0A1172",fg="white",font=ARIAL)
    ...
    def user_withdrawl_money(self):
        ...
        self.money_box = Entry(self.frame,bg="honeydew",highlightcolor="#50A8B0",
           highlightthickness=2,
            highlightbackground="white")
        self.submitButton = Button(self.frame,text="Withdraw",bg="#0A1172",fg="white",font=ARIAL)
    ...
    def video_capture_page(self):
        ...
        #Login Page Form Components
        self.label1 =Label(self.frame,text="Note:",bg="#00688B",fg="white",font=ARIAL)
        self.label2 =Label(self.frame,text="1.By clicking on the 'Capture' button below, your image gets captured ",bg="#00688B",fg="white",font=ARIAL)
        self.label3 =Label(self.frame,text="2.You will be required to capture 5 images for full registration",bg="#00688B",fg="white",font=ARIAL)
        self.label4 =Label(self.frame,text="3.To capture each image click the space bar on your keyboard when the camera turn on:",bg="#00688B",fg="white",font=ARIAL)
        self.label5 =Label(self.frame,text="4. Please wait till you are notified that your capture was successful before leaving the page",bg="#00688B",fg="white",font=ARIAL)
        data = pd.read_csv('bank_details.csv')
        self.label6 =Label(self.frame,text="5.To begin, click the 'Capture' button below and click the space bar to capture a new image",bg="#00688B",fg="white",font=ARIAL)
        self.button = Button(self.frame,text="Capture",bg="#0A1172",fg="white",font=ARIAL,command=self.captureuser)
    ...
    def video_check(self):
        ...
        embedder= cv2.dnn.readNetFromTorch('C:/Users/dell/Desktop/facioatm/nn4.small2.v1.t7')
